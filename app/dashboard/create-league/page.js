...
export default function CreateLeaguePage() {
  ...
  const handleCreate = async (e) => {
    ...
    const { data: league, error: leagueError } = await supabase
      .from('leagues')
      .insert({ league_name: leagueName, admin_id: user.id, invite_code: inviteCode })
      .select()
      .single()
    ...
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-lg mx-auto px-6 py-12">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Set up your league and invite friends with a unique code</p>
        </div>
        ...
        <form onSubmit={handleCreate} className="space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="e.g. The Office Champions" required maxLength={50}
            ...
            />
            <p className="text-gray-500 text-xs mt-1">This is what your friends will see when they join</p>
          </div>
          ...
          <button
            type="submit" disabled={loading || !leagueName.trim()}
