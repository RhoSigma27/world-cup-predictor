// app/api/mini/join-league/route.js
...
export async function POST(request) {
  ...
  // Find mini league by invite code
  ...
  if (leagueError || !league) {
    return NextResponse.json(
      { error: 'League not found. Check the invite code and try again.' },
      { status: 404 }
    )
  }

  // Already a member? Just send them there
  ...
  // Check capacity for new joiners
