...
// final5 base — labels added as sibling row, wider columns, no structural changes
// Rules learned: no 4-value padding, no nested flex:1, no lineHeight, no separate border props
...
export async function GET(request) {
  ...
  return new ImageResponse((
    <div style={{ width: '1200px', height: '630px', background: '#060e1f', display: 'flex', flexDirection: 'column', padding: '36px', fontFamily: 'sans-serif' }}>
      ...
      {/* Labels row — sibling to body, same gap and column widths */}
      <div style={{ display: 'flex', flexDirection: 'row', gap: '16px', marginBottom: '4px' }}>
        <div style={{ width: '220px', textAlign: 'center' }}><span style={{ fontSize: '7px', fontWeight: 600, color: '#2e4a68', letterSpacing: '0.5px' }}>ROUND OF 16</span></div>
        <div style={{ width: '185px', textAlign: 'center' }}><span style={{ fontSize: '7px', fontWeight: 600, color: '#2e4a68', letterSpacing: '0.5px' }}>QUARTER-FINALS</span></div>
        <div style={{ width: '155px', textAlign: 'center' }}><span style={{ fontSize: '7px', fontWeight: 600, color: '#2e4a68', letterSpacing: '0.5px' }}>SEMI-FINALS</span></div>
        <div style={{ width: '130px', textAlign: 'center' }}><span style={{ fontSize: '7px', fontWeight: 600, color: '#2e4a68', letterSpacing: '0.5px' }}>FINAL</span></div>
        <div style={{ flex: 1 }} />
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'row', gap: '16px', flex: 1 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '130px', gap: '4px' }}>
          <div style={{ background: '#1c1400', borderLeft: '3px solid #ca8a04', height: '50px', paddingLeft: '9px', display: 'flex', alignItems: 'center', gap: '8px', borderRadius: '4px' }}>
            <span style={{ fontSize: '22px' }}>{fin.e1}</span>
            <span style={{ color: '#fde68a', fontSize: '14px', fontWeight: 700, whiteSpace: 'nowrap' }}>{fin.t1}</span>
          </div>
          <div style={{ background: fin.t2 === champ ? '#1c1400' : '#0e1e35', borderLeft: fin.t2 === champ ? '3px solid #ca8a04' : '2px solid #2a5080', height: '50px', paddingLeft: '9px', display: 'flex', alignItems: 'center', gap: '8px', borderRadius: '4px' }}>
